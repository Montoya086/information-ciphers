...
if __name__ == "__main__":
    # cbc
    encrypted_cbc,key_cbc,iv_cbc = encrypt_image_aes("./tux.ppm", mode='CBC')
    save_image(encrypted_cbc, "./tux_cbc.ppm")
    
    # ecb
    encrypted_ecb,key_ecb, iv_ecb = encrypt_image_aes("./tux.ppm", mode='ECB')
    save_image(encrypted_ecb, "./tux_ecb.ppm")
